<div class="card mt-3">
	<div class="card-header pb-<?php print (empty($channel->topic) ? 2 : 0); ?>">
		Topic
		<?php
		...
		<?php
			if(empty($channel->topic)) {
				...
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane jsonformat show active" id="pills-preview-topic" role="tabpanel" aria-labelledby="pills-preview-topic-tab" tabindex="0"><?php print json_encode($channel->topic); ?></div>
